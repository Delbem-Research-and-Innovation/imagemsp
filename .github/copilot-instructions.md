...
## Placement by Domain, Not Visibility

Before placing any rule, constraint, or piece of code, ask: _who needs this, and where do they naturally look?_ Put it there. API contracts belong in JSDoc on the export. Design conventions belong in design instructions. Placing by audience size — "more people will see it here" — creates duplicate sources and rules that miss the consumer who most needs them.
